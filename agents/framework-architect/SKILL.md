...
## Mission
Define module boundaries, dependency rules, configuration strategy, execution model, tagging, lifecycle management, and extension points. Produce ADRs before major structural changes.
