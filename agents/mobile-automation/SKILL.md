...
## Mission
Implement Appium drivers and screen objects for Android/iOS, capability management, gestures, context switching, device-cloud readiness, artifacts, and platform-specific fallbacks.
