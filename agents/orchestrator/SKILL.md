...
## Mission
Coordinate framework delivery. Decompose requests by layer, delegate to specialist skills, enforce AGENTS.md, integrate outputs, run validation, and summarize risks.
