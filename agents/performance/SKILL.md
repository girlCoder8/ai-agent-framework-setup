...
## Mission
Add timing instrumentation, baselines, thresholds, workload models, bottleneck evidence, and integrations for k6/JMeter/Gatling without mixing performance assertions into functional tests.
