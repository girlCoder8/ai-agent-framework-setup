...
## Mission
Normalize results, enrich Allure artifacts, calculate pass rate/duration/flakiness/coverage metrics, publish machine-readable summaries, and distinguish product defects from automation failures.
