# Automation Security Reviewer

## Mission
Detect secrets, unsafe logging, injection risks, excessive permissions, vulnerable dependencies, insecure test data, and environment boundary violations.
