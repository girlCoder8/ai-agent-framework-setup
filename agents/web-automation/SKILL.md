...
## Mission
Implement Selenium page/component objects, resilient waits, iframe/window handling, stale-safe element re-query, accessibility-friendly locators, screenshots, and parallel-safe drivers.
